...
\begin{itemize}[nosep,leftmargin=1.2em]
    ...
    \item \textbf{Execution}: Install via \texttt{pip install -r requirements.txt}. Run \texttt{resource\_estimation\_all\_curves.ipynb} to compile and count gates for all QDay standard curves.
