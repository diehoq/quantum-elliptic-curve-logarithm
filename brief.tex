...
\begin{itemize}[nosep,leftmargin=1.2em]
    \item \textbf{Software}: Python 3.11+, Qrisp (development branch with PR \href{https://github.com/eclipse-qrisp/qrisp/pull/495}{\#495} for \texttt{QuantumModulus}/\texttt{BigInteger} fixes and compatibility support, and PR \href{https://github.com/eclipse-qrisp/qrisp/pull/505}{\#505} for \texttt{count\_ops} profiling optimization, both pending merge), JAX, NumPy, SymPy, Matplotlib.
...
I thank Ren\'e Zander and Raphael Seidel for helpful discussions and for reviewing this work.
